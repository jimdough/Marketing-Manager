...
<?PHP
	...
	for ($y=$year; $y>=$lastYear; $y--)	
	{
		
		
	
	// Sets current years month then resets it to December for past months
	if ($y==$year) {
		$m=$month-1;
	} else {
		$m=12;
	...
	// Loops through the months for each yeaqr backwards
	for ($i=$m; $i>=1; $i--)
	{
